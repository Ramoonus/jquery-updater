 ...
 * Description:       This plugin updates jQuery to the latest stable version and let you manage jQuery and jQuery Migrate.
 * Version:           4.0.0
 * Author:            Ramoonus and Remzi Cavdar
 * Author URI:        https://github.com/Ramoonus/jQuery-Updater
 * License:           GPL 3.0
...
// WPJ_UPDATER_PLUGIN - stands for: WordPress jQuery Updater plugin
// Config - CONSTANTS
...
// Default jQuery version (users are able to set their own jQuery version in the wp admin)
...
// Upon activation set default options in db
...
/*
 * WordPress jQuery Updater plugin class, this class gives us flexiblity for doin options and/or debugging
 * Remzi Cavdar
 */
...
function wpj_updater_plugin_front_end_scripts() {
    ...
    if ( $wp_admin || $wp_customizer ) {
        ...
        // Enqueue jQuery in the head, because some plugins broke when we put it in the footer
...
// Defer jQuery Migrate, possibliy add option later to defer jquery for users
